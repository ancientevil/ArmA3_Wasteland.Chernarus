...
nul = ["AIPATROL",2,3500,[false,false],[false,false,true],false,[0,0],[1,0],[0.3,0.4,0.4,0.8,0.8,0.8,0.4,0.4,0.6,0.3],nil,nil,nil] execVM "LV\militarize.sqf";
nul = ["AIPATROL",3,3500,[false,false],[false,false,true],false,[0,0],[1,0],[0.3,0.4,0.4,0.8,0.8,0.8,0.4,0.4,0.6,0.3],nil,nil,nil] execVM "LV\militarize.sqf";
