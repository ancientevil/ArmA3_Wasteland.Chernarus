...
[
	...
	["Mk18 ABR Rifle", "srifle_EBR_F", 3450],
	
	// DLC
	["Mk14 Rifle (Camo) [DLC]", "srifle_DMR_06_camo_F", 4450],
	["Mk14 Rifle (Olive) [DLC]", "srifle_DMR_06_olive_F", 4450],
	["Mk-I EMR Rifle [DLC]", "srifle_DMR_03_F", 4500],
	["Mk-I EMR Rifle (Camo) [DLC]", "srifle_DMR_03_multicam_F", 4550],
	["Mk-I EMR Rifle (Khaki) [DLC]", "srifle_DMR_03_khaki_F", 4550],
	["Mk-I EMR Rifle (Sand) [DLC]", "srifle_DMR_03_tan_F", 4550],
	["Mk-I EMR Rifle (Woodland) [DLC]", "srifle_DMR_03_woodland_F", 4550],
	["MAR-10 Rifle [DLC]", "srifle_DMR_02_F", 4950],
	["MAR-10 Rifle (Camo) [DLC]", "srifle_DMR_02_camo_F", 5000],
	["MAR-10 Rifle (Sand) [DLC]", "srifle_DMR_02_sniper_F", 5000],
	["Cyrus Rifle [DLC]", "srifle_DMR_05_blk_F", 6000],
	["Cyrus Rifle (Hex) [DLC]", "srifle_DMR_05_hex_F", 6050],
	["Cyrus Rifle (Tan) [DLC]", "srifle_DMR_05_tan_f", 6050],

	// Sniper Rifles
	["M320 LRR Sniper", "srifle_LRR_LRPS_F", 9600],
	["M320 LRR Sniper (Camo)", "srifle_LRR_camo_LRPS_F", 9700],
	["ASP-1 Kir Rifle [DLC]", "srifle_DMR_04_F", 9700],
	["ASP-1 Kir Rifle (Tan) [DLC]", "srifle_DMR_04_tan_F", 9800],
	["GM6 Lynx Sniper", "srifle_GM6_LRPS_F", 12900],
	["GM6 Lynx Sniper (Camo)", "srifle_GM6_camo_LRPS_F", 12900]
];

lmgArray = compileFinal str
[
	["MX SW LMG", "arifle_MX_SW_F", 3300],
	["MX SW LMG (Black)", "arifle_MX_SW_Black_F", 3325],
	["Mk200 LMG", "LMG_Mk200_F", 3400],
	["Zafir LMG", "LMG_Zafir_F", 4500],
	["Navid MMG (Tan) [DLC]", "MMG_01_tan_F", 5750],
	["Navid MMG (Hex) [DLC]", "MMG_01_hex_F", 5750],
	["SPMG MMG (Sand) [DLC]", "MMG_02_sand_F", 5750],
	["SPMG MMG (MTP) [DLC]", "MMG_02_camo_F", 5750],
	["SPMG MMG (Black) [DLC]", "MMG_02_black_F", 5800]
];
...
[
	...
	["Titan MPRL Compact (Tan)", "launch_Titan_short_F", 5750],
	["Titan MPRL Compact (Brown)", "launch_O_Titan_short_F", 5750],
	["Titan MPRL Compact (Olive)", "launch_I_Titan_short_F", 5750],
	["Titan MPRL AA (Desert)", "launch_Titan_F", 6750],
	["Titan MPRL AA (Hex)", "launch_O_Titan_F", 6750],
	["Titan MPRL AA (Digi)", "launch_I_Titan_F", 6750]
];
...
[
	...
	["Static Titan AT 4Rnd (NATO)", "B_static_AT_F", 9000], // Static launchers only have 4 ammo, hence the low price
	["Static Titan AT 4Rnd (CSAT)", "O_static_AT_F", 9000],
	["Static Titan AT 4Rnd (AAF)", "I_static_AT_F", 9000],
	["Static Titan AA 4Rnd (NATO)", "B_static_AA_F", 9000],
	["Static Titan AA 4Rnd (CSAT)", "O_static_AA_F", 9000],
	["Static Titan AA 4Rnd (AAF)", "I_static_AA_F", 9000],
	...
	// ["Mk30A HMG .50 Sentry (NATO)", "B_HMG_01_A_F", 6000], // "A" = Autonomous = Overpowered
	// ["Mk30A HMG .50 Sentry (CSAT)", "O_HMG_01_A_F", 6000],
	// ["Mk30A HMG .50 Sentry (AAF)", "I_HMG_01_A_F", 6000],
	...
	["Mk32 GMG 20mm Low tripod (NATO)", "B_GMG_01_F", 8000],
	["Mk32 GMG 20mm Low tripod (CSAT)", "O_GMG_01_F", 8000],
	["Mk32 GMG 20mm Low tripod (AAF)", "I_GMG_01_F", 8000],
...
[
	...
	["Titan Anti-Personnel Missile", "Titan_AP", 2450],        // Direct damage: low       | Splash damage: high   | Guidance: mouse, laser
	["Titan Anti-Air Missile", "Titan_AA", 2600],              // Direct damage: low       | Splash damage: medium | Guidance: aircraft
...
[
	...
	["Nightstalker", "optic_Nightstalker", 27500, "item"]
];
...
[
	...
	["Carryall (Coyote)", "B_Carryall_cbr", 900, "backpack"],
	["Carryall (Hex)", "B_Carryall_ocamo", 900, "backpack"],
...
[
	["UAV Terminal (NATO)", "B_UavTerminal", 1150, "gps"],
	["UAV Terminal (CSAT)", "O_UavTerminal", 1150, "gps"],
	["UAV Terminal (AAF)", "I_UavTerminal", 1150, "gps"],
...
[
	...
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 55000, "vehicle"], // Armed Ka-60 with orca paintjob
	...
	["Mi-48 Kajman (Hex)", "O_Heli_Attack_02_F", 120000, "vehicle"], // Mi-28 with gunner
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 120000, "vehicle"] // Mi-28 with gunner (black camo)
];
...
[
	...
	["LSD", "lsd", localize "STR_WL_ShopDescriptions_LSD", "client\icons\lsd.paa", 85000, 53000],
	["Marijuana", "marijuana", localize "STR_WL_ShopDescriptions_Marijuana", "client\icons\marijuana.paa", 35000, 20000],
	["Cocaine", "cocaine", localize "STR_WL_ShopDescriptions_Cocaine", "client\icons\cocaine.paa", 65000, 40000],
	["Heroin", "heroin", localize "STR_WL_ShopDescriptions_Heroin", "client\icons\heroin.paa", 75000, 50000],
